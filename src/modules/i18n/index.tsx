...
const dictionaries: Record<Locale, Dictionary> = {
  ...
  uz: {
    ...
    "hero.kpi.2": "30% gacha",
    "hero.kpi.2.label": "HVAC salohiyati",
    "hero.kpi.3": "1 ekran",
    ...
    "benefit.energy.items": ["Cho‘qqilar nazorati", "HVAC jadvali", "Ijarachilar hisobi"],
    ...
    "cta.title": "Aniq obyekt uchun TK yarating",
    ...
    "proposal.title": "TK konstruktori",
    "proposal.subtitle": "Ma’lumotlarni tahrirlang — slaydlar avtomatik yangilanadi.",
    "proposal.export.pdf": "PDF eksport",
    "proposal.export.pptx": "PPTX eksport",
    "proposal.form.client": "Mijoz",
    "proposal.form.object": "Obyekt",
    "proposal.form.type": "Obyekt turi",
    "proposal.form.offer": "Taklif tavsifi",
    "proposal.form.offer.placeholder": "Saytdagi amaldagi xizmat tavsifidan foydalanish uchun bo‘sh qoldiring.",
    ...
    "proposal.slide.effect.annual": "Ssenariy samarasi / yil",
