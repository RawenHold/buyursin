...
const content = {
  ru: {
    ...
    projects: { eyebrow: "Опыт", title: <>Опыт, который можно<br />применить к вашему объекту.</>, text: "Показываем объекты и бренды компании. Детальные цифры публикуются после подтверждения." },
